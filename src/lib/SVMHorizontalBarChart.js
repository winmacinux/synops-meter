...
class SVMHorizontalBarChart extends Component {
  constructor(props) {
    super(props);
    this.state={
  ...
  render() {
    ...
    const { dataset, labels, unit } = this.props;
    const state = {
      labels: labels,
      datasets: [
        {
          ...
          datalabels: {
            ...
            formatter: function(value) {
              ...
              let res = formatNumber(value) === null ? "" : formatNumber(value) + ` ${unit}`;
              return res;
            },
...
export { SVMHorizontalBarChart };
export default SVMHorizontalBarChart;
